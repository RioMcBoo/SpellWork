...
internal class WDC5Reader : BaseEncryptionSupportingReader
{
    private const int HeaderSize = 72;

    private const uint WDC5FmtSig = 893600855u;

    public WDC5Reader(string dbcFile)
    ...
    public WDC5Reader(Stream stream)
    {
        ...
        if (binaryReader.ReadUInt32() != 893600855)
        {
            throw new InvalidDataException("WDC5 file is corrupted!");
        }
